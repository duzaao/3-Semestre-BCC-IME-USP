...
double complex evalf(double complex z) {
    return cpow(z, 4.0) - 2.0 * z + 3.0;
}

double complex evalDf(double complex z) {
    return 4.0 * cpow(z, 3.0) - 2.0;
}
...
void newton_basins(double l, double u, int p) {
    ...
    // Soluções da equação x⁴ - 2x + 3 = 0
    double complex sol[4] = { 1.2642 + 0.0000*I, -0.6321 + 1.1547*I, -0.6321 - 1.1547*I, -0.0000 + 0.0000*I };
    ...
    fprintf(gp, "set term pngcairo size 1500,1000\n");
